...
mod tests {
    ...
    use rust_lib::resolver::puzzle::*;
	use rust_lib::resolver::generate::r_generate_state_index;
    ...
    fn function_r_is_solvable() {
        ...
        let vector_index = r_generate_state_index(&vector);
        let puzzle: Puzzle = Puzzle::new(vector, vector_index, size, 0, Move::NONE);
